<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @elseif(Auth::user()->role == '1')
                        <x-nav-link href="{{ route('dashboard-client-index') }}" :active="request()->routeIs('dashboard-client-index')">
                            {{ __('Dashboard') }}
                        </x-nav-link>
                        <x-nav-link href="{{ route('ternak-index') }}" :active="request()->routeIs('ternak-index')">
                            {{ __('Hewan Ternak') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
                @if(Auth::user()->role == '0')
                    <x-responsive-nav-link href="{{ route('ternak-index') }}" :active="request()->routeIs('ternak-index')">
                        {{ __('Hewan Ternak') }}
                ...
                @elseif(Auth::user()->role == '1')
                    <x-responsive-nav-link href="{{ route('dashboard-client-index') }}" :active="request()->routeIs('dashboard-client-index')">
                        {{ __('Dashboard') }}
                    </x-responsive-nav-link>
